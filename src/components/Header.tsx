...
export default function Header() {
    ...
    return (
        <>
            <header className="fixed top-9 left-0 right-0 z-50 bg-zen-bone/90 backdrop-blur-md border-b border-zen-sage/10 transition-all duration-300">
            ...
            {/* Slide-in Panel */}
            <nav
                className={`fixed top-[100px] left-0 bottom-0 w-4/5 max-w-xs bg-zen-bone z-40 md:hidden transform transition-transform duration-300 ease-out shadow-2xl ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}
